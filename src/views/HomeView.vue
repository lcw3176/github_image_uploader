<template>
  <v-container fluid>
    <main class="text-center font-weight-light"
      style="--v-layout-left: 0px; --v-layout-right: 0px; --v-layout-top: 144px; --v-layout-bottom: 0px;">
      <div class="v-container v-locale--is-ltr">
        <div class="v-row align-center justify-center">
          ...
          <div class="v-col v-col-auto text-center text-lg-start">
            <h1 class="text-h2 font-weight-medium mb-3 ms-n1"> Image to URL </h1>
            <p class="mb-10 mx-auto ms-lg-0" style="max-width: 568px;">
              The url printer works based on Github issues and supports convenient image registration and resizing.
            </p>
            <div class="v-row">

              <div class="v-col v-col-auto"><a
                  ...
                  style="background-color: rgb(33, 33, 33); color: rgb(255, 255, 255); caret-color: rgb(255, 255, 255); min-width: 215px;"><span
                    ...
                    data-no-activator=""><i class="v-icon notranslate v-theme--dark v-icon--size-default v-icon--start"
                      ...
                      </svg></i> GitHub</span></a></div>
            </div><br>
          </div>
        </div>
      </div><br>

      <h2 class="v-heading mb-2 text-h4 text-sm-h4"><a aria-current="page" href="/en/#project-sponsors"
          class="router-link-active router-link-exact-active text-decoration-none text-end text-md-start d-none d-sm-inline-block"
      ...
      <footer class="v-footer d-block py-6" id="footer" style="height: auto;">
        <div class="v-container v-locale--is-ltr text-center">
          <div class="v-row">
            <div class="v-col v-col-12">
              <div class="v-responsive v-img mx-auto" contain="" style="height: 64px; width: 64px;">
                <div class="v-responsive__sizer" style="padding-bottom: 86.6848%;"></div><img
                  class="v-img__img v-img__img--contain"
            ...
            <div class="v-col v-col-12">
              <div>Released under the <a class="text-medium-emphasis text-decoration-underline"
                  href="https://opensource.org/licenses/MIT" path="mit-license" rel="noopener" target="_blank">MIT
                  License</a></div>
            </div>
          </div>
        </div>
